...
public class NodeInfo {
    ...
    public BigInteger addComplain(String complainFrom, long timestamp, int nodeCount) {
        Complaints complaints = new Complaints(this.jsonObject.getString("complaints", ""));
        complaints.addComplain(complainFrom, timestamp);
        this.jsonObject.set("complaints", complaints.toString());
    ...
    public void fromParams(String endpoint,
        ...
        this.jsonObject.set("complaints", this.jsonObject.getString("complaints", ""));
    }
    ...
    public static NodeInfo fromString(String node_info) {
        ...
        jsonObject.set("complaints", json.getString("complaints", jsonObject.getString("complaints", "")));
    ...
    public Complaints complaints() {
        return new Complaints(this.jsonObject.getString("complaints", ""));
    }
